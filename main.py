...
#     elif body_mass_index in np.arange(18.5,22.9):
#         st.write('Berat Badan anda Normal!')
#     elif body_mass_index in np.arange(23,24.9):
...
#             st.write('Berat Badan anda Normal!')
#         elif body_mass_index in np.arange(23,24.9,0.1):
#             st.write('Berat Badan anda Berlebihan')
#         elif body_mass_index > 25 :
#             st.write('Anda Obesitas!')
...
#         BMR_f = (10 * berat_badan_bmr) + (6.25 * tinggi_badan_bmr) - (5 * usia) - 161 
#         return BMR_f
    
#     def bmr_m(berat_badan_bmr,tinggi_badan_bmr,usia):
#         BMR_m = (10 * berat_badan_bmr) + (6.25 * tinggi_badan_bmr) - (5 * usia) + 5
#         return BMR_m
...
# Jika jarang berolahraga, kalikan BMR dengan 1.2.
# Jika berolahraga 1 hingga 3 hari dalam seminggu, kalikan BMR dengan 1.375.
# Jika berolahraga 3 hingga 5 hari dalam seminggu, kalikan BMR dengan 1.55.
# Jika berolahraga 6 hingga 7 hari dalam seminggu, kalikan BMR dengan 1.725.
# Jika memiliki pekerjaan fisik yang berat atau berolahraga dua kali dalam sehari, kalikan BMR dengan 1.9.
